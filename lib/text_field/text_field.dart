...
class _LETextFieldSelectionGestureDetectorBuilder
    extends TextSelectionGestureDetectorBuilder {
  _LETextFieldSelectionGestureDetectorBuilder({
    @required _LETextFieldState state,
  })  : _state = state,
        super(delegate: state);

  final _LETextFieldState _state;
...
///     return LETextField(controller: _textController);
///   }
/// }
/// ```
/// {@end-tool}
...
class LETextField extends StatefulWidget {
  ...
  ///
  /// Defaults to the standard iOS font style from [LETheme] if null.
  ...
  /// ## Limitations
  ///
  /// The LETextField does not currently count Unicode grapheme clusters
  ...
  ///
  /// Defaults to the [LEThemeData.primaryColor] of the ambient theme,
  /// which itself defaults to [LEColors.activeBlue] in the light theme
  /// and [LEColors.activeOrange] in the dark theme.
  ...
  final GestureLongPressCallback onPrefixLongPress;

  @override
  _LETextFieldState createState() => _LETextFieldState();
...
class _LETextFieldState extends State<LETextField>
  ...
  _LETextFieldSelectionGestureDetectorBuilder _selectionGestureDetectorBuilder;
  ...
  void initState() {
    ...
    _selectionGestureDetectorBuilder =
        _LETextFieldSelectionGestureDetectorBuilder(state: this);
  ...
  @override
  void didUpdateWidget(LETextField oldWidget) {
  ...
  // LETextField has top alignment by default, unless it has decoration
  ...
  Widget _buildPrefix() {
    ...
    children.add(widget.prefix);
    children.add(SizedBox(width: 16.0));
    children.add(_buildDivider());
    children.add(SizedBox(width: 16.0));

    return GestureDetector(
      onLongPress: widget.onPrefixLongPress,
      child: Row(
        children: children,
      ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle textStyle = themeData.typography.head.apply(
      color: themeData.style.contentHeavy,
    );
    final TextStyle placeholderStyle = themeData.typography.head.apply(
      color: Color(0xFFC1C1C1),
    );
    final Brightness keyboardAppearance = Brightness.light;
    final Color cursorColor = themeData.style.contentHeavy;
    final Color disabledColor = Color(0xFFF1F1F4);
    ...
    final Widget paddedEditable = Padding(
      ...
      child: RepaintBoundary(
        child: EditableText(
          ...
          backgroundCursorColor: Color(0xFFFFFFAA),
